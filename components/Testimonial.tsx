                ...
                >
                  {testimonials
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="group h-full bg-white backdrop-blur-xs border-[.5px] border-(--highlight)/50 rounded-2xl sm:rounded-3xl p-5 sm:p-6 lg:p-8 shadow-sm hover:shadow-xl hover:shadow-(--dark)/5   hover:border-(--highlight)/40 transition-all duration-300 flex flex-col justify-between min-h-65 sm:min-h-75 lg:min-h-85"
                      >
                        {/* Top */}
                        <div>
