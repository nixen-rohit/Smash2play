...
const Powered = () => {
  return (
    <section className="bg-(--dark-bg) text-(--dark-text) p-6 md:p-12 font-sans">
        ...
        <div className="bg-(--dark-bg)/10 rounded-[40px] overflow-hidden flex flex-col md:flex-row items-center p-4 md:p-8 border-2 border-(--highlight)/10">
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center text-white relative">
            ...
            <Link
              ...
              className="inline-flex items-center justify-between bg-(--highlight) px-6 py-4 rounded-full font-bold w-fit hover:bg-white transition-colors group"
            >
              Explore Callories
