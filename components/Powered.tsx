  ...
  return (
    <section className="bg-(--white-bg) p-6 md:p-12 font-sans">
      <div className="max-w-6xl mx-auto space-y-8">
        <h2 className="text-(--white-text) text-4xl text-center md:text-5xl font-bold mb-6 leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8">
          <div className="flex flex-col justify-center">
            <h3 className="text-4xl md:text-5xl text-(--white-text) font-black leading-tight uppercase italic">
